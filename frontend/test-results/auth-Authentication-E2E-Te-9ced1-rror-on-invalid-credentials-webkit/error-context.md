...
- Name: auth.spec.ts >> Authentication E2E Tests >> should show error on invalid credentials
    ...
    - generic [ref=e5]:
      - generic [ref=e6]:
        ...
        - navigation "Главная навигация" [ref=e10]:
          - link "Руководители" [ref=e11]:
            - /url: /dashboard
          - link "Инженерные группы" [ref=e12]:
            - /url: /projects
          - link "Производство" [ref=e13]:
            - /url: /production
          - link "Документооборот" [ref=e14]:
            - /url: /documents
          - link "Согласования" [ref=e15]:
            - /url: /approvals
          - link "Аудит и контроль" [ref=e16]:
            - /url: /audit
      - generic [ref=e17]:
          ...
          - generic [ref=e143]:
            ...
            - generic [ref=e149]:
              - generic [ref=e151]:
                ...
                - generic [ref=e153]: "0"
              - generic [ref=e156]:
                - generic [ref=e157]: Завершённые
                - generic [ref=e158]: "0"
              - generic [ref=e161]:
                - generic [ref=e162]: Риски
                - generic [ref=e163]: "0"
            - button "Смотреть отчет" [ref=e166] [cursor=pointer]:
              - generic [ref=e168]:
                - text: Смотреть отчет
                - img [ref=e169]
          - generic [ref=e172]:
            - generic [ref=e173]:
              - generic [ref=e174]:
                ...
                - heading "Закрыть 3 задачи без просрочки" [level=3] [ref=e182]
                - paragraph [ref=e183]: Выполни план дня и получи дополнительные очки в инженерном рейтинге.
              - img [ref=e185]
            - generic [ref=e190]: Выполнено 2 из 3 шагов
            - button "Открыть задачи" [ref=e192] [cursor=pointer]:
              - generic [ref=e193]: Открыть задачи
```
